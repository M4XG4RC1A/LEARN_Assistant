...
def MandarLink(Link):
    ...
    pass
def BtnLlama(Nombre):
	Documento = "C:\\Users\\maxga\\OneDrive\\Documentos\\ActividadesPersonal\\MiniBootCamp\\Contactos\\ContactosZoom.txt"
...
root=Tk()
root.title("Llamada Zoom")
Fondo = PhotoImage(file=Imagenes+"FZoom.png")
